...
<main class="login-form">
    <div class="container p-5">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Sửa thông tin lớp học</h3>
                    <div class="card-body">
                        <form method="POST" action="{{ route('updateClass', $class->id) }}">
                            @csrf
                            <div class="form-group mb-3">
                                <select name="level" id="level" class="form-control" value="{{ $class->level_id }}"
                                    required autofocus>
                            ...
                            <div class="form-group mb-3">
                                <input type="date" placeholder="Ngày bắt đầu" id="start_day" class="form-control"
                                    name="start_day" value="{{ $class->start_day }}" required>
                            </div>
                            <div class="form-group mb-3">
                                <input type="date" placeholder="Ngày kết thúc" id="end_day" class="form-control"
                                    name="end_day" value="{{ $class->end_day }}" required>
                            </div>
                            <div class="form-group mb-3">
